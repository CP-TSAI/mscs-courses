...
q2_1_step_C = 0
q2_1_step_D = 0
q2_infinite_step_A = 0
q2_infinite_step_B = 0
q2_infinite_step_C = 0
q2_infinite_step_D = 0
...
q3_works_fine                 = None
q3_ignores_robot_measurements = None
q3_ignores_robot_motion       = None
q3_it_likely_fails            = None
q3_none_of_above              = None
...
def list_of_float_to_str(lst): return str(list(map(float_to_str, lst)))
...
CODE_TEST_CASES = ({'function_name': 'grader_q4',
                    ...
                    'function_input': dict(length=20.,
                                           ...
                                           steering_noise=0.1,
                                           distance_noise=5.0,
                                           motions=[[old_div(2. * pi, 10), 20.] for row in range(8)],
                                           measurements=[
